        ...
        <div className="thin-grid md:grid-cols-3">
          {posts.map((post) => (
            <Link key={post.slug} href={`/blog/${post.slug}`} className="group thin-cell">
              ...
              <span className="mt-auto flex items-center justify-between rounded-[5px] border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 px-3 py-2 font-mono text-xs text-gray-900 dark:text-gray-100 transition-colors group-hover:border-primary-600 group-hover:text-primary-600 dark:group-hover:border-primary-400 dark:group-hover:text-primary-400">
